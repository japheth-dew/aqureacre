  ...
  return (
    <div className={`lg:px-[4rem] md:p-[3rem] p-[1rem]  ${classes.container}`}>
      ...
      >
        ...
        <div className="rounded-md border-red-400  mx-auto border-[2px] pl-5 w-full  flex ">
          <input
            className="flex-1 focus:outline-none bg-transparent text-black"
            type="email"
            placeholder="Enter your email address"
          />
          <button className="bg-red-400 font-[600] text-white hover:scale-[110%]  rounded-md px-[18px] py-[10px]">
            Sign Up{" "}
          </button>
        </div>
      </motion.div>
