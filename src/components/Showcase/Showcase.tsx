    ...
    >
      ...
      >
        <div className=" h-[100%] flex flex-col gap-4 justify-center  md:text-black text-blue-900   ">
          ...
          <span className="md:text-justify md:backdrop-sepia-0 md:text-[20px] text-[1.9em] md:bg-blue-900/80 md:text-white bg-none md:font-[500] text-blue-900 font-[600]  p-2">
